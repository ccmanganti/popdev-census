...
class DistributionOfPopulationByEmploymentStatusAndSex extends ApexChartWidget
{
    /**
     * Chart Id
     *
    ...
    protected static string $chartId = 'distributionOfPopulationByEmploymentStatusAndSex';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Distribution of Population by Source of Income/Employment Status and Sex';
    ...
    public function getPREmploymentAndSex($ageAndSex) {
        $user = auth()->user();
        $json_data_count = 0;
        ...
        foreach($json_data as $json){
            foreach($json->individual_record as $data){
                if(($data['q3'] === $ageAndSex[1]) && ($data['q16'] === $ageAndSex[0])){
                    $json_data_count += 1;
                }
            }
        }    
        ...
        return [
            ...
            'series' => [
                [
                    'name' => 'Male',
                    'data' => [
                        $this->getPREmploymentAndSex(['1', '1', $province, $city_or_municipality, $barangay]),
                        $this->getPREmploymentAndSex(['2', '1', $province, $city_or_municipality, $barangay]),
                        $this->getPREmploymentAndSex(['3', '1', $province, $city_or_municipality, $barangay]),
                        $this->getPREmploymentAndSex(['4', '1', $province, $city_or_municipality, $barangay]),
                        $this->getPREmploymentAndSex(['5', '1', $province, $city_or_municipality, $barangay]),
                        $this->getPREmploymentAndSex(['6', '1', $province, $city_or_municipality, $barangay]),
                    ],
                ],
                [
                    'name' => 'Female',
                    'data' => [
                        -$this->getPREmploymentAndSex(['1', '2', $province, $city_or_municipality, $barangay]),
                        -$this->getPREmploymentAndSex(['2', '2', $province, $city_or_municipality, $barangay]),
                        -$this->getPREmploymentAndSex(['3', '2', $province, $city_or_municipality, $barangay]),
                        -$this->getPREmploymentAndSex(['4', '2', $province, $city_or_municipality, $barangay]),
                        -$this->getPREmploymentAndSex(['5', '2', $province, $city_or_municipality, $barangay]),
                        -$this->getPREmploymentAndSex(['6', '2', $province, $city_or_municipality, $barangay]),
                    ],
                ],
            ],
            'xaxis' => [
            ...
            'yaxis' => [
                ...
                'title' => [
                    'text' => 'Source of Income/Employment Status',
                ],
            ],
            'plotOptions' => [
                'bar' => [
