...
class DistributionOfHouseholdsByLandOccupancyAndHouseholdSize extends ApexChartWidget
{
    /**
     * Chart Id
     *
    ...
    protected static string $chartId = 'distributionOfHouseholdsByLandOccupancyAndHouseholdSize';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'II. Distribution of Households by LandOccupancy and Household Size';
    ...
    public function getHHHouseAndSize($ageAndSex) {
        ...
        foreach($json_data as $json){
            if(($json['q26'] === $ageAndSex[1] && $json['household_members_total'] == $ageAndSex[0] && (int)$json['household_members_total'] <= 9)){
                $json_data_count += 1;
            } else if(($json['q26'] === $ageAndSex[1] && $json['household_members_total'] == $ageAndSex[0] && (int)$json['household_members_total'] >= 10)){
                $json_data_count += 1;
            }
        }
