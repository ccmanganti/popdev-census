...
class DistributionOfPopulationByEthnicityAndSex extends ApexChartWidget
{
    /**
     * Chart Id
     *
    ...
    protected static string $chartId = 'distributionOfPopulationByEthnicityAndSex';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'V. Distribution of Population by Ethnicity and Sex';
    ...
    public function getPREthnicityAndSex($ageAndSex) {
        ...
        foreach($json_data as $json){
            foreach($json->individual_record as $data){
                if(($data['q3'] === $ageAndSex[1]) && ($data['q10'] === $ageAndSex[0])){
                    $json_data_count += 1;
                }
            }
        }    
            ...
            'series' => [
                [
                    ...
                    'data' => [
                        ...
                        $this->getPREthnicityAndSex(['14', '1', $province, $city_or_municipality, $barangay]),
                    ],
                ],
                [
                    'name' => 'Female',
                    'data' => [
                        ...
                        -$this->getPREthnicityAndSex(['14', '2', $province, $city_or_municipality, $barangay]),
                    ],
                ],
            ],
            'xaxis' => [
